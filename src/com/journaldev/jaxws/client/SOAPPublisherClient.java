...
public class SOAPPublisherClient {
	...
	public static void main(String[] args) throws MalformedURLException {
		URL wsdlURL = new URL("http://localhost:8080/SOAPWSExample/services/PersonServiceImpl?wsdl");//("https://localhost:8888/ws/person?wsdl");
		//check above URL in browser, you should see WSDL file
		
		//creating QName using targetNamespace and name
		QName qname = new QName("http://service.jaxws.journaldev.com", "PersonServiceImplService");//("https://service.jaxws.journaldev.com/", "PersonServiceImplService"); 
		
		Service service = Service.create(wsdlURL, qname);  
		
		//We need to pass interface and model beans to client
		PersonServiceImpl ps = service.getPort(PersonServiceImpl.class);//getPort(qname, PersonServiceImpl.class);
